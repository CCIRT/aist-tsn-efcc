...
class TestModule(utility.TestModuleBase):
    ...
    def _generate_pattern_port0(self, send_port, flows=[0, 4], show_sequence=True):
        ...
        PAD = (int((1542+7)/8) * 8 - int((84+7)/8) * 140) * 8
...
def main():
    ...
    parser.add_argument('--port1_gap', default=152, type=int, help='The gap bytes to port1 (max=65535)')
    ...
    tm.test(140 + 8, 0, 0, 'results/test_no_shift', show_sequence=False)
