...
proc init_gui { IPINST } {
  ...
  #Adding Group
  set Port4 [ipgui::add_group $IPINST -name "Port4" -parent ${Page_0} -layout horizontal]
  ipgui::add_param $IPINST -name "ENABLE_PORT_4" -parent ${Port4}
  ipgui::add_param $IPINST -name "PORT_ID_4" -parent ${Port4}

  #Adding Group
  set Port5 [ipgui::add_group $IPINST -name "Port5" -parent ${Page_0} -layout horizontal]
  ipgui::add_param $IPINST -name "ENABLE_PORT_5" -parent ${Port5}
  ipgui::add_param $IPINST -name "PORT_ID_5" -parent ${Port5}

  #Adding Group
  set Port6 [ipgui::add_group $IPINST -name "Port6" -parent ${Page_0} -layout horizontal]
  ipgui::add_param $IPINST -name "ENABLE_PORT_6" -parent ${Port6}
  ipgui::add_param $IPINST -name "PORT_ID_6" -parent ${Port6}

  #Adding Group
  set Port7 [ipgui::add_group $IPINST -name "Port7" -parent ${Page_0} -layout horizontal]
  ipgui::add_param $IPINST -name "ENABLE_PORT_7" -parent ${Port7}
  ipgui::add_param $IPINST -name "PORT_ID_7" -parent ${Port7}
